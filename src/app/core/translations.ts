...
export function getTranslations(lang: 'vi' | 'en'): AppTranslations {
  ...
  return {
    ...
    supportedFormats: isVi 
      ? 'Hỗ trợ định dạng: <strong>MP4, WebM</strong><br><span class="text-xs">(Hoạt động tốt nhất trên trình duyệt Chrome hoặc Edge trên hệ điều hành Windows)</span>'
      : 'Supported formats: <strong>MP4, WebM</strong><br><span class="text-xs">(Best performance on Chrome or Edge browser on Windows)</span>',
    supportedAudioFormats: isVi ? 'Hỗ trợ: MP3, WAV, M4A' : 'Supported: MP3, WAV, M4A',
    ...
    errInvalidFormat: isVi 
      ? `Định dạng tệp không được hỗ trợ. Vui lòng chọn tệp MP4 hoặc WebM.` 
      : `Unsupported file format. Please select an MP4 or WebM file.`,
